    ...
    <div className="container mx-auto">
      ...
      <div>
        ...
        <div className="flex justify-center flex-wrap gap-4 ">
          <div className=" w-[250px] h-[300px] rounded-lg bg-indego relative">
            ...
            <div className="absolute top-2 right-2 w-8 h-8 rounded-xl bg-lightindego ">
              <h1>
                <span className="w-full h-8 grid justify-center items-center cursor-pointer">
